                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            if($customer_id != NULL){
                            ?>
                            <li class="dropdown"><a href="#">Hi, {{Session::get('customer_name')}}<i class="fa fa-angle-down"></i></a>
                            ...
                            <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="{{URL::to('/all-product-page')}}">Sản Phẩm</a>
                                        <span class="badge badge-primary badge-pill"> {{\App\product::where('product_status', 0)->count()}}</span>
                                    </li>
                                    <li><a href="#">Thương hiệu </a>
                                        <span class="badge badge-primary badge-pill"> {{\App\brand::where('brand_status', 0)->count()}}</span>
                                    </li>
                                    <li><a href="#">Danh Mục</a>
                                        <span class="badge badge-primary badge-pill"> {{\App\categoryProduct::where('category_status', 0)->count()}}</span>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a
                                            href="{{URL::to('/danh-muc-san-pham/'.$cate->category_slug)}}">{{$cate->category_name}} </a>
                                    </h4>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="{{URL::to('/thuong-hieu-san-pham/'.$bra->brand_slug)}}">
                                            <span class="pull-right"></span>{{$bra->brand_name}}
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
